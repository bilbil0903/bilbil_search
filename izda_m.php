...
<img id="logo" src="index.png" width="270" height="109" >
<form method="get" accept-charset="utf-8" >
<span id="suggest-align" class="">
<input type="text"  name="wd" required="required"  autocomplete="off" id="input" maxlength="100"  value="<?php echo $wd;?>" oninput="OnInput (event)" />
